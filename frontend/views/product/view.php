					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<?php if($product->new) : ?>
									<?= Html::img("@web/eshopper/images/home/new.png", ['alt' => 'Новинка', 'class' => 'newarrival']); ?>
								<?php endif; ?>
								<?php if($product->sale) : ?>
									<?= Html::img("@web/eshopper/images/home/sale.png", ['alt' => 'Распродажа', 'class' => 'newarrival']); ?>
								<?php endif; ?>
								<h2><?= $product->name ?></h2>
								<p>Web ID: 1089772</p>
								...
								<p><b>Brand:</b> <a href="<?= Url::to(['category/view', 'id' => $product->category->id]) ?>"><?= $product->category->name ?></a></a></p>
